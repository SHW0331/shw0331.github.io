...
- `JNE SHORT 7FF6_631B1030` : TEST의 비교 결과가 0이 아니므로, `7FF6_631B1030` 주소로 점프
...
- 해당 어셈블리 코드 확인
- `LEA RCX, [REL 7FF6_631B2258]` :
- `CALL QWORD PTR [REL <&api-ms-win-crt-stdio-l1-1-0.puts>]` : 
- CMD 창에 **Wrong** 출력
